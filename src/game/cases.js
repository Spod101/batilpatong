...
export const EASY_CASE = {
  ...
  suspects: [
    { id: 'clara',  portrait: 'characters/ClaraDumont.png',  name: 'Clara Dumont', role: 'Shop Manager',    description: 'Has worked at the boutique for 8 years. Has master key access and was last seen near the cabinet before closing.', alibi: '"I was doing inventory in the back room. The cabinet was fine when I left, I swear."', guilty: true  },
    { id: 'marcus', portrait: 'characters/MarcusWebb.png',   name: 'Marcus Webb',  role: 'Sales Clerk',     description: 'New employee with unpaid debts. Knows the shop layout but lacks key access to the heirloom display.',             alibi: '"I signed out at 11 AM — an hour before this happened. Check the security log."',           guilty: false },
    { id: 'sandra', portrait: 'characters/SandraPark.png',   name: 'Sandra Park',  role: 'Security Guard',  description: 'On duty the day of the theft. The security footage went dark for 20 minutes during her patrol window.',             alibi: '"I was on patrol the whole afternoon. I never went near that cabinet."',                   guilty: false },
  ],
  facts: [
...
export const MEDIUM_CASE = {
  ...
  suspects: [
    { id: 'victor',  portrait: 'characters/VictorCrane.png',    name: 'Victor Crane',  role: 'Ex-Jewel Thief',      description: "Runs a pawn shop on Ashford St. Known for his signature red scarf and gem-trade contacts.",                 alibi: '"At the Blue Note Jazz Club all evening. The bartender knows me."',                  guilty: true  },
    { id: 'nadia',   portrait: 'characters/NadiaVoss.png',      name: 'Nadia Voss',    role: 'Museum Curator',      description: "Former head of acquisitions. Knew the vault layout and security rotation firsthand.",                      alibi: '"Home alone all evening. No witnesses — but I have nothing to hide."',              guilty: false },
    { id: 'dominic', portrait: 'characters/DominicVale.png',   name: 'Dominic Vale',  role: 'Security Contractor', description: "Hired to oversee gallery security the night of the theft. His guard fell asleep at his post.",           alibi: '"Making rounds in the east wing all night. My guard\'s failure shames me."',         guilty: false },
    { id: 'iris',    portrait: 'characters/IrisKwan.png',       name: 'Iris Kwan',     role: 'Socialite',           description: "Attended the gala where the necklace was displayed. Left before the rest of the guests.",                 alibi: '"Car service picked me up at 10:30 PM. Gone long before midnight."',                guilty: false },
    { id: 'rex',     portrait: 'characters/RexHolden.png',      name: 'Rex Holden',    role: 'Antiques Dealer',     description: "Known to broker high-value stolen pieces. Has buyers for gems like the Blue Diamond.",                    alibi: '"At the Sotheby\'s auction in Caldwell City. Hotel records confirm my stay."',      guilty: false },
  ],
  facts: [
...
export const HARD_CASE = {
  ...
  suspects: [
    { id: 'eva',       portrait: 'characters/EvaVoss.png',          name: 'Eva Voss',          role: 'Personal Assistant',   description: "The maestro's trusted assistant for 11 years. Named sole heir in the new will. Tended his private herb garden.", alibi: '"I was preparing his evening tea as I always did. I was the one who found him."',         guilty: true  },
    { id: 'alexei',   portrait: 'characters/AlexeiBorkov.png',      name: 'Alexei Borkov',     role: 'Rival Conductor',      description: "Public feud with the maestro over a prestigious residency. Known for his volatile temper and grudges.",            alibi: '"I was conducting in Vienna that evening. The concert hall will confirm it."',            guilty: false },
    { id: 'helena',   portrait: 'characters/HelenaStrauss.png',     name: 'Helena Strauss',    role: 'Widow',                description: "The maestro's wife of 30 years. Was cut out of the new will entirely and threatened legal action publicly.",       alibi: '"At my sister\'s house in the country. She will vouch for me."',                         guilty: false },
    { id: 'friedrich',portrait: 'characters/FriedrichKohl.png',     name: 'Friedrich Kohl',    role: 'Business Manager',     description: "Manages the estate finances. Would lose his advisory contract under the new will.",                                alibi: '"In a board meeting until midnight. Seven witnesses can confirm."',                       guilty: false },
    { id: 'lena',     portrait: 'characters/LenaBraun.png',         name: 'Lena Braun',        role: 'Sous Chef',            description: "Prepared all meals. Had access to the kitchen and pantry. No obvious motive.",                                    alibi: '"Cleaning the kitchen after dinner service. The head chef saw me all evening."',          guilty: false },
    { id: 'wilhelm',  portrait: 'characters/WilhelmFaber.png',      name: 'Dr. Wilhelm Faber', role: 'Family Physician',     description: "The maestro's doctor for 20 years. Prescribed all medications and knew every health vulnerability.",              alibi: '"Emergency call across town. Hospital records confirm the callout time."',                 guilty: false },
    { id: 'otto',     portrait: 'characters/OttoKranz.png',         name: 'Otto Kranz',        role: 'Estate Groundskeeper', description: "Maintains the gardens and grounds. Has access to all outbuildings, including the private herb garden.",           alibi: '"Locking up the greenhouse at dusk. My signature is in the estate log."',                 guilty: false },
  ],
  facts: [
